# Доработаем задачи 3 и 4. Создайте класс Project, содержащий атрибуты – список
# пользователей проекта и админ проекта. Класс имеет следующие методы:
...
import json
from seminar13_3_4 import User
...
class Project:
    ...
    def fill_project_users(cls):
        ...
        with open("users_13_5.json", "r", encoding="utf-8") as j:
            file = json.load(j)
            temp = []
            for key in file:
