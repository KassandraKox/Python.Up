...
hike = {
    'John': ('Палатка', 'Спальник', 'Спички', 'Нож', 'Фонарь'),
    'Jack': ('Палатка', 'Спальник', 'Нож', 'Фонарь', 'Дрова'),
    'Bivis': ('Палатка', 'Спальник', 'Фонарь', 'Лодка', 'Бензин'),
    'Badhead': ('Машина', 'Спальник', 'Спички', 'Дрова', 'Книга')
}
