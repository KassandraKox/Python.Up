...
# У класса должны быть методы birthday для увеличения возраста на год, full_name для вывода
# полного ФИО и т.п. на ваш выбор.
# Cвойство возраст должно быть недоступно для прямого обращения, но возможность получить
# текущий возраст должна присутствовать.
